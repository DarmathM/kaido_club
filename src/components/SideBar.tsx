    ...
    return(
        <div className={`${isOpen ? "translate-x-0 opacity-100"  : "-translate-x-full opacity-0"} fixed flex flex-col px-10 pt-20 left-0 h-full w-100 bg-(--text) z-100 transition-all duration-300`}>
            ...
            <ul className="flex flex-col gap-12 ">
                ...
                <a className="flex items-center justify-between text-[1.3rem] text-(--ink)  bg-(--light-contrast) p-4 rounded-2xl font-medium">Contact<span className="material-symbols-outlined cursor-pointer flex items-center">chevron_right</span></a>
